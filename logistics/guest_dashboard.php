                                  ...
                                  if($result!="no")
                                   {
                                    ...
                                    foreach($result as $key => $val)
                                    {
                                        ...
                                        echo '<td class="a-right a-right"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg"onclick="return showcustomerdocument('.$result[$key]['consignment_id'].')">Document</button> </td>';
                                        echo '<td class="a-right a-right"> <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg2" onclick="return showshipmentdetails('.$result[$key]['consignment_id'].')">Click here</button></td>';
                                        echo "</tr>";
                                      $i++;
                                     } 
