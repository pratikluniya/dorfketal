        ...
        foreach($result as $key => $val)
        {
          ...
          echo "<tr class='even pointer'>";
            ...
            echo "<td class='a-right a-right'>".$result[$key]['order_status']."</td>";
              echo '<td class=""> <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg4"onclick="return showcustomerdocument('.$result[$key]['consignment_id'].') ">Document</button> </td>';
              echo '<td class=""> <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg5" onclick="return showshipmentdetails('.$result[$key]['consignment_id'].') ">Click here</button></td>';
            echo "</tr>";
