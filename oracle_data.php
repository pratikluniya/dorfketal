...
$conn = oci_connect('APPS','patch','172.25.25.112:1531/TEST');
    if (!$conn) {
        $e = oci_error();
        trigger_error(htmlentities($e['message'], ENT_QUOTES), E_USER_ERROR);
    }

$stid3 = oci_parse($conn, "SELECT SALES_AGREEMENT_NUMBER, SALES_AGREEMENT_NAME, CUSTOMER_NAME, CUSTOMER_NUMBER, SALES_AGREEMENT_DATE, LINE_ID, ORG_ID, HEADER_ID, LINE_NUMBER, ORDERED_ITEM, ORDER_QUANTITY_UOM, DESCRIPTION, START_DATE_ACTIVE, END_DATE_ACTIVE, SALESREP_ID, CUST_PO_NUMBER, PRICE_LIST,TERMS, SHIPPING_METHOD_CODE, FREIGHT_TERMS_CODE, SHIP_FROM_LOCATION, SHIP_TO, SHIP_TO_LOCATION, SHIP_TO_ADDRESS1, SHIP_TO_ADDRESS2, SHIP_TO_ADDRESS3, SHIP_TO_ADDRESS4, INVOICE_TO, INVOICE_TO_LOCATION, INVOICE_TO_ADDRESS1, INVOICE_TO_ADDRESS2, INVOICE_TO_ADDRESS3, INVOICE_TO_ADDRESS4, INVOICE_TO_ADDRESS5, DELIVER_TO, DELIVER_TO_LOCATION, DELIVER_TO_ADDRESS1, DELIVER_TO_ADDRESS2, DELIVER_TO_ADDRESS3, DELIVER_TO_ADDRESS4, DELIVER_TO_ADDRESS5, BLANKET_MAX_QUANTITY, BLANKET_MIN_QUANTITY, RELEASED_QUANTITY, FULFILLED_QUANTITY, RETURNED_QUANTITY, UNRELEASED_QUANTITY, UNFULFILLED_QUANTITY, RELEASED_AMOUNT, FULFILLED_AMOUNT, RETURNED_AMOUNT, SHIP_FROM_ORG_ID, SHIP_TO_ORG_ID, INVOICE_TO_ORG_ID, DELIVER_TO_ORG_ID, SOLD_TO_ORG_ID, INVENTORY_ITEM_ID
    FROM XDK_SALES_AGREEMENT_V");
