...
<div class="container">
	<div class="col-md-6">
		<form id="checkout_data">
			...
			<div class="form-group">
				<button type="button" class="btn btn-primary" id="additional_info_btn"><i class="fa fa-plus-circle"></i> Additional Information</button>
			</div>
					...
					<select class="form-control" id="payment_term">
						...
						<?php
							foreach($result_payment_terms as $key => $value):
								echo '<option value="'.$value['TERM_ID'].'">'.$value['DESCRIPTION'].'</option>'; //close your tags!!
							endforeach;
						?>
					</select>
				</div>
